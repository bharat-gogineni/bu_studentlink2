        ...
        return [
            'factories' => [
                Adapter\LoginAdapter::class => function ($container) {
                    ...
                    return new Adapter\LoginAdapter($dbAdapter, 'users', 'username', 'password', 'MD5(SHA1(?))');
                },
                ...
                Service\AuthService::class => function ($container) {
                    $dbAdapter = $container->get(AdapterInterface::class);
                    return new Service\AuthService($container->get('config'), $dbAdapter, $container->get(UserService::class));
                },
            ],
        ];
    }
