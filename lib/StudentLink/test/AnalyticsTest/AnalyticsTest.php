...
use StudentLink\Test\ControllerTest;
use StudentLink\Db\ModelTable;
use PHPUnit\DbUnit\TestCaseTrait;
use PHPUnit\DbUnit\DataSet\YamlDataSet;
use Zend\Db\Sql\Sql;
use Zend\Db\Adapter\Adapter;
use StudentLink\Analytics\Elastic\AnalyticsEngineImpl;
use StudentLink\Search;
use StudentLink\Search\Indexer;
use StudentLink\Analytics;
use PHPUnit\DbUnit\DataSet\SymfonyYamlParser;
use StudentLink\Test\MainControllerTest;
...
class AnalyticsTest extends MainControllerTest
{
    ...
    public function setUp() : void
    {
        ...
        $this->elasticService = $this->getApplicationServiceLocator()->get(\StudentLink\Service\ElasticService::class);
