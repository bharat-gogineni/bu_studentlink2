...
use StudentLink\Service\EsignService;
use Exception;
use Mockery;
...
use StudentLink\Model\Esign\EsignDocument;
use StudentLink\Model\Esign\EsignDocumentSigner;
...
class EsignServiceTest extends AbstractServiceTest
{
    ...
    public function setUp(): void
    {
        $this->loadConfig();
        parent::setUp();
        $this->esignService = $this->getApplicationServiceLocator()->get(\StudentLink\Service\EsignService::class);
    ...
    {
        $mockMessageProducer = Mockery::mock('StudentLink\Messaging\MessageProducer');
