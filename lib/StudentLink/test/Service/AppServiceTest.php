...
use StudentLink\Test\AbstractServiceTest;
use StudentLink\Service\AppService;
...
class AppServiceTest extends AbstractServiceTest
{
    ...
    {
        $mockProcessManager = Mockery::mock('\StudentLink\Workflow\Camunda\ProcessManagerImpl');
        $workflowService = $this->getApplicationServiceLocator()->get(\StudentLink\Service\WorkflowService::class);
    ...
    {
        $taskService = $this->getApplicationServiceLocator()->get(\StudentLink\Service\JobService::class);
        $mockRestClient = Mockery::mock('StudentLink\Utils\RestClient');
    ...
    public function testGetAppWithInvalidUuid()
    {
        ...
        } catch (\StudentLink\EntityNotFoundException $e) {
            $this->assertNotNull($e);
        }
    }
    ...
    public function testProcessSymlinks()
    {
        if (enableExecUtils == 0) {
            $mockBosUtils = Mockery::mock('alias:\StudentLink\Utils\ExecUtils');
