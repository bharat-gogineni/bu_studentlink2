<?php
namespace StudentLink\Document\Parser\Spreadsheet;
...
class SpreadsheetParserTest extends TestCase
{
    ...
    public function testLoadWithInvalidFilterClass()
    {
        ...
        $this->expectException(Exception::class);
        $this->expectExceptionMessage("Filter should be of type \StudentLink\Document\Parser\Spreadsheet\SpreadsheetFilter");
    ...
    public function testLoadWithInvalidRowMapperClass()
    {
        ...
        $this->expectException(Exception::class);
        $this->expectExceptionMessage("RowMapper should be of type \StudentLink\Document\Parser\Spreadsheet\RowMapper");
